...

{
  ...
  {
    echo $query="SELECT `id` FROM `signup` WHERE `signup_mob_number`='".mysqli_real_escape_string($con_ser,$login_mob_number)."' AND `signup_password`='".mysqli_real_escape_string($con_ser,$pass_hash)."'";
     echo query;
    if($query_run=mysqli_query($con_ser,$query))
    {
...
<h2  class="hidden-xs"><font color="black">TAXATION WITHOUT REPRESENTATION IS TYRANNY.</font></h2>
<h4   class="visible-xs"><font color="black">TAXATION WITHOUT REPRESENTATION IS TYRANNY.</font></h4>
...
<div class="flat-form"">
  ...
  <div id="login" class="form-action show">
    <h1>Login</h1>
    <form action="<?php echo $current_filename; ?>"  method="post">
      <ul class="list-unstyled">
      
        <li>
          <input type="text" name="login_mob_number" class="form-control" id="login_mob_number" placeholder="Username/Mobile No." /><br>
            <li/>
            <li>
